package com.awakenedredstone.lildonk.client.render.model;
...
public class PenguinModel extends AnimalModel<Penguin> {
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new Identifier(LilDonk.MOD_ID, "penguin"), "main");
    ...
    public PenguinModel(ModelPart root) {
        super(RenderLayer::getEntityTranslucentCull, true, 4.75F, 0.0F, 1.5f, 2.0f, 24.0f);
    ...
    public static TexturedModelData createBodyLayer() {
        ...
        partdefinition.addChild("head", ModelPartBuilder.create()
                .uv(0, 16).cuboid(-3.0F, -5.01F, -3.0F, 6.0F, 5.0F, 6.0F, new Dilation(0.0F))
                .uv(23, 0).cuboid(-1.0F, -2.0F, -5.0F, 2.01F, 2.01F, 2.01F, new Dilation(0.0F)),
